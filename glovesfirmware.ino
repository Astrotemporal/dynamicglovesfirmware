...
#define COMMUNICATION COMM_SERIAL //Which communication protocol to use (COMM_SERIAL or COMM_BTSERIAL)
//serial over USB
  #define SERIAL_BAUD_RATE 115200
  
//serial over Bluetooth
  #define BTSERIAL_DEVICE_NAME "dynamicgloves-right"
...
//PINS CONFIGURATION 
  ...
  #define PIN_PINKY_MOTOR     5 //used for force feedback
  #define PIN_RING_MOTOR      6 //^
  #define PIN_MIDDLE_MOTOR    7 //^
  #define PIN_INDEX_MOTOR     8 //^
  #define PIN_THUMB_MOTOR     9 //^
  #define PIN_MENU_BTN        2
#endif
